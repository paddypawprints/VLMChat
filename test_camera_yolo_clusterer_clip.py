#!/usr/bin/env python3
"""
Test camera -> yolo -> clusterer -> clip pipeline.
Tests clustered detections with CLIP vision and text comparison.
"""
...
def test_camera_yolo_clusterer_clip():
    """Test camera + test_input -> yolo -> clusterer -> clip vision + text -> compare"""
    print("\n" + "="*70)
    print("TEST: Camera + Test Input -> YOLO -> Clusterer -> CLIP Pipeline")
    print("="*70)
    ...
    try:
        ...
        dsl_file = "pipelines/camera_yolo_clusterer_clip.dsl"
        ...
        print("CLIP comparison complete - check logs for match results")
...
if __name__ == "__main__":
    success = test_camera_yolo_clusterer_clip()
