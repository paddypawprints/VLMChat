#!/usr/bin/env python3
"""
Test camera -> YOLO -> viewer pipeline.
"""
...
def test_camera_yolo_viewer():
    """Test camera -> YOLO -> viewer pipeline."""
    print("\n" + "="*70)
    print("TEST: Camera -> YOLO -> Viewer Pipeline")
    print("="*70)
    ...
    try:
        ...
        dsl_file = "pipelines/camera_yolo_viewer.dsl"
        ...
        print("Check for viewer output PNG files with YOLO detections!")
...
if __name__ == "__main__":
    try:
        success = test_camera_yolo_viewer()
